...
For more details, see the guide on [Databases](core_concepts.md).
...
For more details, see the guide on [Authorization](core_concepts.md).
...
For more details, see the guide on [OpenAPI Documentation](core_concepts.md).
